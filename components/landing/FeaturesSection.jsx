      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5">
          ...
          <div className="space-y-8">
            {features.map(f => (
              <div key={f.title} className="border-l-4 border-ink pl-6 py-2 hover-paper bg-transparent hover:bg-white/50 transition-colors">
        ...
        <div className="lg:col-span-7">
          <div className="border-4 border-ink p-2 h-full min-h-[400px]">
            <div className="w-full h-full border-2 border-ink bg-paper flex items-center justify-center relative overflow-hidden group hover-paper">
              ...
              <div className="bg-cream border-2 border-ink px-8 py-6 text-center z-10 shadow-hard rotate-[-2deg] group-hover:rotate-0 transition-transform duration-300">
