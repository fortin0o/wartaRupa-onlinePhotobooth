...
const HomeScreen = ({ onSelectTemplate }) => {
  ...
  // â”€â”€ Shared: render a theme-selection grid â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div className={`flex flex-col items-center min-h-screen ${bgColor} py-12 px-4`}>
      <div className="text-center mb-12">
        ...
        <p className="font-garamond italic text-gray-700">
          {themes.length} tema tersedia â€” pilih yang paling sesuai mood-mu.
        </p>
      </div>
